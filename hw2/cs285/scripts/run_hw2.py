...
def main():
    ...
    parser.add_argument('--exp_name', type=str, default='q5_b2000_r0.001_lambda_0.99')
    ...
    parser.add_argument('--batch_size', '-b', type=int, default=2000) #steps collected per train iteration
    ...
    parser.add_argument('--action_noise_std', type=float, default=0.5)
