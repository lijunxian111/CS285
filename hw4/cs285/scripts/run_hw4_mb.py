...
def main():
    ...
    parser.add_argument('--exp_name', type=str, default='q3_obstacles')
    parser.add_argument('--n_iter', '-n', type=int, default=12)

    parser.add_argument('--ensemble_size', '-e', type=int, default=3)
    parser.add_argument('--mpc_horizon', type=int, default=10)
    parser.add_argument('--mpc_num_action_sequences', type=int, default=20)
    ...
    parser.add_argument('--batch_size_initial', type=int, default=5000) #(random) steps collected on 1st iteration (put into replay buffer)
    parser.add_argument('--batch_size', '-b', type=int, default=1000) #steps collected per train iteration (put into replay buffer)
