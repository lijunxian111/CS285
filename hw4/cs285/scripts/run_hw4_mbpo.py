...
def main():
    ...
    parser.add_argument('--exp_name', type=str, default='q6')
    ...
    parser.add_argument('--batch_size', type=int, default=1000) #steps collected per train iteration (put into replay buffer)
